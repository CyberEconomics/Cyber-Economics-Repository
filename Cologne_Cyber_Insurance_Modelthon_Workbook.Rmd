...
load("C:\\Users\\Daniel\\Documents\\GitHub\\Cologne-Cyber-Insurance-Modelthon\\data\\premiumarray")

weights = SimulationresultArray[1,,,]
...
calculate_insurance_outcomes <- function(weights,verification_set,initial_wealth_array){
  ...
  implied_premiums_with_expense_ratio = model_premium_without_expense_ratio /0.7 + implied_premiums_with_expense_ratio
...
test_2 = calculate_insurance_outcomes(weights, verification_set, scneario_1_IW)
