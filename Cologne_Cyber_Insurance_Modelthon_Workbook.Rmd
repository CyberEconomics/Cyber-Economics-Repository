...
# Example usage
test_outcome <- test_outcome2_constrained[[2]][[1]]
plot <- plot_matrix(test_outcome)
print(plot)
```
...
reinsurance_matrix_1 = rbind(rep(1,5),rep(1,5),rep(1,5),rep(1,5))
...
bond_values_effiency_curve_ils = c(5000,5000	,1415.67,	707.83)
...
test_outcome1_unconstrained = calculate_insurance_outcomes(var95.0_results[1,,,], verification_set, IW_array, 1)

test_outcome1_constrained = calculate_insurance_outcomes(var95.0_results[1,,,], verification_set, IW_array, 1)


test_outcome2_unconstrained = calculate_reinsurance_outcomes(var95.0_results[1,,,], verification_set, IW_array, reinsurance_matrix_1, 0)

test_outcome2_constrained = calculate_reinsurance_outcomes(var95.0_results[1,,,], verification_set, IW_array, reinsurance_matrix_1, 0)
...
bond_values_effiency_curve_ils = c(7.273063e+03, 3.636531e+03, 1.818266e+03,	9.091329e+02)

#ILS effectivness
scenario_3_results_ils_unconstrained = calculate_reinsurance_ils_outcomes(var95.0_results[1,,,], verification_set, scenario_3_IW, reinsurance_matrix_1,bond_value_array,0.7, 0.04)
scenario_3_results_ils_constrained = calculate_reinsurance_ils_outcomes(var95.0_results[1,,,], verification_set, scenario_3_IW, reinsurance_matrix_1,bond_value_array,0.7, 0.04)

#ILS effectivness
scenario_3_results_ils_unconstrained_curve = calculate_reinsurance_ils_outcomes(var95.0_results[1,,,], verification_set, scenario_3_IW, reinsurance_matrix_1,bond_values_effiency_curve_ils,0.7, 0.04)
scenario_3_results_ils_constrained_curve = calculate_reinsurance_ils_outcomes(var95.0_results[1,,,], verification_set, scenario_3_IW, reinsurance_matrix_1,bond_values_effiency_curve_ils,0.7, 0.04)

#ILS Outcomes with Reinsurance Outcomes
scenario_3_results_ils_RP200_unconstrained = calculate_reinsurance_ils_hypothetical_bond_outcome(var95.0_results[1,,,], verification_set, IW_array, reinsurance_matrix_1,bond_value_array,0.7, 0.04,.95)
scenario_3_results_ils_RP200_constrained = calculate_reinsurance_ils_hypothetical_bond_outcome(var95.0_results[1,,,], verification_set, IW_array, reinsurance_matrix_1,bond_value_array,0.7, 0.04,.95)

#ILS Outcomes with Reinsurance Outcomes
scenario_3_results_ils_RP200_unconstrained = calculate_reinsurance_ils_hypothetical_bond_outcome(var95.0_results[1,,,], verification_set, IW_array, reinsurance_matrix_1,bond_values_effiency_curve_ils,0.7, 0.04,.95)
scenario_3_results_ils_RP200_constrained = calculate_reinsurance_ils_hypothetical_bond_outcome(var95.0_results[1,,,], verification_set, IW_array, reinsurance_matrix_1,bond_values_effiency_curve_ils,0.7, 0.04,.95)
