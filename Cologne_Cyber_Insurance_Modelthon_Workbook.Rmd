...
#' @output Returns a list with tons of good stuff!
#'
calculate_reinsurance_ils_outcomes <- function(weights, verification_set, initial_wealth_array, reinsurance_matrix, mode, bond_value,target_sharpe_ratio, risk_free_rate){
