...
scenario_4_CC_IW = c(3.6e4,3.6e4 + 0.135e4,3.6e4 + 0.135e4*2,3.6e4 + 0.135e4*3,3.6e4 + 0.135e4*4 )
...
for (i in 1:dim_cc){
  #Calculate Value and bind to new frame. First seed the pseudo array with the double rows and return
  capital_curve_ils_pseudo_array[,,1] = SimulationresultArray[i,,,]
  capital_curve_ils_pseudo_array[,,2] = SimulationresultArray[i,,,]
