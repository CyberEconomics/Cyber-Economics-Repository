...
sum_uninsured_losses =  sum(excess_uninsured_loss)/(num_sim_runs*n_runs),
Attatchment_Probability_Bond = sum(ifelse(bond_loss > 0,1,0))/(num_sim_runs*n_runs),
Probability_of_excess_loss = sum(ifelse(excess_uninsured_loss > 0,1,0))/(num_sim_runs*n_runs)
 )
...
bond_value = c(21,10.5,5.25,2.6) 

scenario_3_results_ils = calculate_reinsurance_ils_outcomes(constrained_optimization_results[1,,,], verification_set_new, scenario_3_IW, reinsurance_matrix_1,bond_value,1, 0.02)
