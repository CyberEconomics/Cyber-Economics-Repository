...
#load files from priv repo
load(paste0(wd,"/data/unconstrained_results.rdata"))
unconstrained_results = SimulationresultArray
load(paste0(wd,"/data/constrained_optimization.rdata"))
constrained_results = SimulationresultArray
load(paste0(wd,"/data/capital_curve_priv.RData"))
capital_curve_new = SimulationresultArray


#Loading DAmage, Premium and Expense Ratio Data
load(paste0(wd,"/data/general_input_august23.rdata"))
...
for (i in 1:dim_cc){
  ...
  current_values_cc = calculate_insurance_outcomes(capital_curve_pseudo_array, verification_set, scenario_2_IW[i], 1)
...
scenario_3_results = calculate_reinsurance_outcomes(constrained_optimization_results[1,,,], verification_set, scenario_3_IW, reinsurance_matrix_1, 1)
