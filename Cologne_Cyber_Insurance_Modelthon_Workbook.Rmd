...
scenario_3_results_ils_RP100 = calculate_reinsurance_ils_hypothetical_bond_outcome(constrained_optimization_results[1,,,], verification_set, scenario_3_IW, reinsurance_matrix_1,bond_value_array,1, 0.02,.99)
...
#Similar to the capital curve, we need to explicitly declare the array, because if else, the last (4th) dimension of the original array gets wiped. So we just double the array, and just take the first value. However, for the ils array, we need to do this twice. 


ils_pseudo_array = array(dim = c(2,dim(ils_bond_scenario_1)[[2]],dim(ils_bond_scenario_1)[[3]],2))
ils_pseudo_array[1,,,1] = ils_bond_scenario_1[1,,,1]
ils_pseudo_array[1,,,2] = ils_bond_scenario_1[1,,,1]
ils_pseudo_array[2,,,1] = ils_bond_scenario_1[1,,,1]
ils_pseudo_array[2,,,2] = ils_bond_scenario_1[1,,,1]

#Bond Value 

ils_reinsurance_matrix = matrix(c(0.135e4), nrow = 1, ncol = 1)
ils_bond_results_1 = calculate_reinsurance_ils_hypothetical_bond_outcome(ils_pseudo_array[1,,,], verification_set, scenario_4_IW, ils_reinsurance_matrix,bond_value_array,1, 0.02,.99)
